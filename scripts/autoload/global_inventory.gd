...
func cargar_starter_pack():
	limpiar_inventario()
	add_item("Sifón", 5)
	add_item("Prisma Recto", 20)
	add_item("Prisma Angular", 10)
	add_item("Compresor", 2)
	add_item("Fusionador", 1)
	add_item("Constructor", 1)
	add_item("Void Generator", 1)
	add_item("Sifon T2", 1)
	add_item("Prisma Recto", 3)
	add_item("Prisma Angular", 10)
