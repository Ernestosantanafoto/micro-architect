...
var unlock_conditions = {
	...
	# Fabricador Hadrón: Fusionador (tech) + 10 Constructores colocados
	"Fabricador Hadrón": {"type": "building_count", "building": "Constructor", "amount": 10},
}
...
func _unlock_initial_techs():
	# Tecnologías disponibles desde el inicio (incl. Compresor: 1 unidad en STARTER_PACK).
	var initial = ["Sifón", "Prisma Recto", "Prisma Angular", "Compresor"]
	for tech in initial:
