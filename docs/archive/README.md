...
Documentos conservados como referencia histórica. **La documentación activa está en la raíz de `docs/`.**

- **ANALISIS_UNIFICACION_MDS.md** — Análisis de unificación entre docs antiguos y Nuevos MDs (feb 2025).
